...
export const timeline = [
  {
    ...
    title: "海陽中等教育学校",
    subtitle: "",
    description: "愛知県蒲郡市に位置する全寮制中高一貫校。部活動では映像部に所属し、公式記録動画やイベント用ムービーを多数制作。学園祭パンフレットや生徒会誌のデザインも担当。4・5年次（高校1・2年相当）には映像部部長として部活を牽引するとともに、2期連続で6学年を束ねる生徒会執行役員を拝命し、発想力と技術面で活動を支えた。4年次には寮のフロア長を複数回担い、日常的な統率やメンバー親睦イベントの企画にも尽力。また複数回にわたり、学業・生活面で模範的とされる学生に贈られるHonor Studentsに選出された。この時期に独学でHTMLやCSSの学習を開始。",
  },
  {
